...
/* ⭐ Helper: existing chart destroy karo */
...
/* ⭐ Reveal animations — opacity 0 thi 1 karo */
...
document.addEventListener('DOMContentLoaded', () => {
  initCurrentDate();        // ⭐ Date fill
  initRevealAnimations();   // ⭐ Content visible karo
  animateCounters();        // ⭐ Stats animate
  initHomeworkSubmit();
  initResultChart();
  initTimetable();
});
...
function initResultChart() {
  ...
  destroyChartIfExists('resultChart');  // ⭐ pehla destroy
  ...
  try {
    ...
    // Calculate percentages if outOf data exists
...
function initTimetable() {
  // Timetable interactive features
}