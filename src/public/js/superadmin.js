  ...
  list.forEach((school, index) => {
    ...
    row.innerHTML = `
      ...
      <td class="py-3.5 text-right">
        <a href="/superadmin/schools/${school.id}" class="inline-flex items-center justify-center gap-1 px-3 py-1.5 rounded-lg border border-slate-200 text-slate-700 hover:bg-slate-50 font-bold transition-all text-[11px] no-underline">
