    ...
    delete: async (req, res) => {
        try {
            ...
            await withTransaction(async (tx) => {
                ...
                await tx.execute("DELETE FROM attendance WHERE school_id = ?", [schoolId]);
                await tx.execute("DELETE FROM fees WHERE school_id = ?", [schoolId]);
                await tx.execute("DELETE FROM settings WHERE school_id = ?", [schoolId]);
                await tx.execute("DELETE FROM students WHERE school_id = ?", [schoolId]);
                await tx.execute("DELETE FROM teachers WHERE school_id = ?", [schoolId]);
                await tx.execute("DELETE FROM drivers WHERE school_id = ?", [schoolId]);
                await tx.execute("DELETE FROM librarians WHERE school_id = ?", [schoolId]);
                await tx.execute("DELETE FROM student_family WHERE school_id = ?", [schoolId]);
                await tx.execute("DELETE FROM classes WHERE school_id = ?", [schoolId]);
                await tx.execute("DELETE FROM sections WHERE school_id = ?", [schoolId]);
                await tx.execute("DELETE FROM subjects WHERE school_id = ?", [schoolId]);
                await tx.execute("DELETE FROM fee_payments WHERE school_id = ?", [schoolId]);
                await tx.execute("DELETE FROM fee_structures WHERE school_id = ?", [schoolId]);
                await tx.execute("DELETE FROM leaves WHERE school_id = ?", [schoolId]);
                await tx.execute("DELETE FROM notices WHERE school_id = ?", [schoolId]);
                await tx.execute("DELETE FROM events WHERE school_id = ?", [schoolId]);
                await tx.execute("DELETE FROM homeworks WHERE school_id = ?", [schoolId]);
                await tx.execute("DELETE FROM exams WHERE school_id = ?", [schoolId]);
                await tx.execute("DELETE FROM marks WHERE school_id = ?", [schoolId]);
                await tx.execute("DELETE FROM routes WHERE school_id = ?", [schoolId]);
                await tx.execute("DELETE FROM vehicles WHERE school_id = ?", [schoolId]);
                await tx.execute("DELETE FROM books WHERE school_id = ?", [schoolId]);
                await tx.execute("DELETE FROM group_admin_schools WHERE school_id = ?", [schoolId]);
