...
/**
 * Generates a two-page PDF (CR80 size) for Student or Teacher ID Card.
 * Width: 242.64 pt (3.375 in)
 * Height: 153.0 pt (2.125 in)
 */
async function generateIdCardPdf({ type, name, idNo, frontDetail1, frontDetail2, frontDetail3, photo, school, qrText, backDetail1, backDetail2 }) {
  ...
  const primaryColor = isStudent ? '#6366F1' : '#10B981'; // Indigo for Student, Emerald for Teacher
  ...
  // Signature and Website at bottom
  doc.strokeColor('#E2E8F0')
     .lineWidth(0.5)
     .moveTo(16, height - 24)
